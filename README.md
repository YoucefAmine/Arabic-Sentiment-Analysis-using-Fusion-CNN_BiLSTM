...
- ### Model:
In this model which is a fusion of the CNN and BiLSTM models, we kept the same architectures previously used with only adding a 0.2 dropout rate to the LSTM cells. The architecture used is shown in the figure below.

![cnn-bilstmarchitecture](https://user-images.githubusercontent.com/45196964/214376628-9be8ab0e-d1ef-499a-a6d7-589a1474c4ba.png)

- ### Results:
| Datasets  | Precision | Recall | F1-Score | **Accuracy** |
| --------- | --------- | ------ | -------- | ------------ |
| **ArSAS** | 77%       | 69%    | 72%      | `73.02%`     |
| **LABR**  | 90%       | 90%    | 90%      | `90.25%`     |
| **HARD**  | 95%       | 95%    | 95%      | `94.93%`     |
